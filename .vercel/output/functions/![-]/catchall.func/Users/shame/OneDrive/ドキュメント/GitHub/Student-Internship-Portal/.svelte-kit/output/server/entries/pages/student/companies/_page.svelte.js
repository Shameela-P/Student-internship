...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let searchVal = filters().query;
		let selectedIndustry = filters().industry;
		let selectedDomain = filters().domain;
		let searchLocation = filters().location;
		let selectedMode = filters().mode;
		...
		$$renderer.push(`<section class="relative py-20 px-6 rounded-3xl overflow-hidden bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 border border-slate-200 dark:border-slate-800/80 mb-12 text-center shadow-2xl svelte-1i3s90c"><div class="absolute top-[-30%] left-[-20%] w-[60%] h-[60%] rounded-full bg-blue-500/10 blur-[120px] pointer-events-none animate-pulse-slow svelte-1i3s90c"></div> <div class="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-cyan-500/5 blur-[120px] pointer-events-none animate-pulse-slow svelte-1i3s90c" style="animation-delay: 2s;"></div> <div class="absolute inset-0 pointer-events-none overflow-hidden select-none opacity-40 svelte-1i3s90c"><div class="absolute top-10 left-10 md:left-20 animate-float-1 bg-slate-800/90 border border-slate-700/50 p-3 rounded-2xl shadow-xl flex items-center gap-3 svelte-1i3s90c"><div class="bg-blue-500/20 text-blue-400 p-2 rounded-xl svelte-1i3s90c"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 svelte-1i3s90c" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" class="svelte-1i3s90c"></path></svg></div> <div class="text-left text-xs svelte-1i3s90c"><p class="font-bold text-slate-900 dark:text-white svelte-1i3s90c">Full Stack Intern</p> <p class="text-slate-600 dark:text-slate-400 svelte-1i3s90c">TCS • Active</p></div></div> <div class="absolute bottom-10 left-6 md:left-32 animate-float-2 bg-slate-800/80 border border-slate-700/50 p-2 px-3 rounded-xl shadow-lg flex items-center gap-2 svelte-1i3s90c"><span class="text-cyan-400 font-bold font-display text-sm svelte-1i3s90c">Zoho</span> <span class="h-1.5 w-1.5 rounded-full bg-emerald-500 svelte-1i3s90c"></span></div> <div class="absolute top-8 right-8 md:right-24 animate-float-3 bg-slate-800/90 border border-slate-700/50 p-3 rounded-2xl shadow-xl flex items-center gap-3 svelte-1i3s90c"><div class="bg-amber-500/20 text-amber-400 p-2 rounded-xl svelte-1i3s90c"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 svelte-1i3s90c" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" class="svelte-1i3s90c"></path></svg></div> <div class="text-left text-xs svelte-1i3s90c"><p class="font-bold text-slate-900 dark:text-white svelte-1i3s90c">Verified Certificate</p> <p class="text-slate-600 dark:text-slate-400 svelte-1i3s90c">ID: NX-8902-A</p></div></div> <div class="absolute bottom-16 right-12 md:right-36 animate-float-1 bg-slate-800/90 border border-slate-700/50 p-3 rounded-2xl shadow-xl flex items-center gap-3 svelte-1i3s90c"><div class="bg-emerald-500/20 text-emerald-400 p-2 rounded-xl svelte-1i3s90c"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 svelte-1i3s90c" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" class="svelte-1i3s90c"></path></svg></div> <div class="text-left text-xs svelte-1i3s90c"><p class="font-bold text-slate-900 dark:text-white svelte-1i3s90c">Career Growth</p> <p class="text-emerald-400 svelte-1i3s90c">+148% Placements</p></div></div></div> <div class="relative z-10 max-w-4xl mx-auto flex flex-col items-center svelte-1i3s90c"><div class="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-semibold mb-6 shadow-sm svelte-1i3s90c"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="svelte-1i3s90c"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" class="svelte-1i3s90c"></path><path d="m9 12 2 2 4-4" class="svelte-1i3s90c"></path></svg> 100% Verified Corporate Partners</div> <h1 class="font-display font-black text-4xl md:text-6xl text-slate-900 dark:text-white leading-tight tracking-tight svelte-1i3s90c">Explore <span class="bg-linear-to-r from-blue-400 via-cyan-400 to-emerald-400 text-gradient svelte-1i3s90c">5500+ Verified Companies</span></h1> <p class="mt-5 text-sm md:text-base text-slate-600 dark:text-slate-400 max-w-2xl leading-relaxed svelte-1i3s90c">Find internships from top recruiters, startups, and global companies across 150+ domains. Apply directly to active postings and launch your career.</p> <div class="mt-8 flex flex-col sm:flex-row gap-4 items-center justify-center svelte-1i3s90c"><a href="#directory" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-slate-900 dark:text-white font-bold text-sm shadow-lg shadow-blue-500/20 hover:shadow-blue-500/35 hover:scale-[1.02] transition-all duration-250 cursor-pointer svelte-1i3s90c">Explore Companies</a> <a href="/student/internships" class="w-full sm:w-auto px-8 py-3.5 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-900 text-slate-300 hover:text-slate-900 dark:text-white font-bold text-sm hover:scale-[1.02] transition-all duration-250 cursor-pointer svelte-1i3s90c">Find Internships</a></div></div></section> <section class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12 svelte-1i3s90c"><div class="p-6 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/80 text-center backdrop-blur-sm relative group overflow-hidden svelte-1i3s90c"><div class="absolute inset-0 bg-gradient-to-b from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 svelte-1i3s90c"></div> <span class="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest block svelte-1i3s90c">Corporate Partners</span> <h2 class="font-display font-black text-2xl md:text-4xl text-blue-400 mt-2 svelte-1i3s90c">${escape_html(companiesCount)}+</h2></div> <div class="p-6 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/80 text-center backdrop-blur-sm relative group overflow-hidden svelte-1i3s90c"><div class="absolute inset-0 bg-gradient-to-b from-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 svelte-1i3s90c"></div> <span class="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest block svelte-1i3s90c">Applications Filed</span> <h2 class="font-display font-black text-2xl md:text-4xl text-emerald-400 mt-2 svelte-1i3s90c">${escape_html(applicationsCount)}+</h2></div> <div class="p-6 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/80 text-center backdrop-blur-sm relative group overflow-hidden svelte-1i3s90c"><div class="absolute inset-0 bg-gradient-to-b from-purple-500/5 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 svelte-1i3s90c"></div> <span class="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest block svelte-1i3s90c">Active Candidates</span> <h2 class="font-display font-black text-2xl md:text-4xl text-purple-400 mt-2 svelte-1i3s90c">${escape_html(studentsCount)}+</h2></div> <div class="p-6 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/80 text-center backdrop-blur-sm relative group overflow-hidden svelte-1i3s90c"><div class="absolute inset-0 bg-gradient-to-b from-cyan-500/5 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 svelte-1i3s90c"></div> <span class="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest block svelte-1i3s90c">Domain Streams</span> <h2 class="font-display font-black text-2xl md:text-4xl text-cyan-400 mt-2 svelte-1i3s90c">${escape_html(domainsCount)}+</h2></div></section> <section class="mb-16 py-5 border-y border-slate-200 dark:border-slate-800/80 bg-slate-100 dark:bg-slate-900/30 svelte-1i3s90c"><div class="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-6 svelte-1i3s90c"><div class="shrink-0 text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest svelte-1i3s90c">Top Recruiters:</div> <div class="marquee-container grow svelte-1i3s90c"><div class="marquee-track svelte-1i3s90c"><!--[-->`);
		const each_array = ensure_array_like([...featuredRecruiters, ...featuredRecruiters]);
		for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
			let recruiter = each_array[$$index];
			$$renderer.push(`<span class="text-sm font-black font-display text-slate-600 dark:text-slate-400 hover:text-blue-400 transition-colors duration-200 cursor-default svelte-1i3s90c">${escape_html(recruiter)}</span>`);
		}
		$$renderer.push(`<!--]--></div></div></div></section> <section id="directory" class="mb-16 svelte-1i3s90c"><div class="mb-8 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-6 svelte-1i3s90c"><div class="svelte-1i3s90c"><h2 class="font-display font-black text-2xl text-slate-900 dark:text-white svelte-1i3s90c">Corporate Register</h2> <p class="text-xs text-slate-600 dark:text-slate-400 mt-1 svelte-1i3s90c">Search through verified corporate registries and find matching workspaces.</p></div> <form method="GET" class="w-full xl:max-w-5xl flex flex-wrap items-center gap-3 svelte-1i3s90c"><div class="relative grow min-w-[200px] svelte-1i3s90c"><input type="text" name="query"${attr("value", searchVal)} placeholder="Search company or description..." class="w-full pl-9 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 svelte-1i3s90c"/> <svg class="absolute left-3 top-3.5 h-3.5 w-3.5 text-slate-600 dark:text-slate-400 svelte-1i3s90c" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><circle cx="11" cy="11" r="8" stroke-width="2" class="svelte-1i3s90c"></circle><line x1="21" x2="16.65" y1="21" y2="16.65" stroke-width="2" stroke-linecap="round" class="svelte-1i3s90c"></line></svg></div> <div class="min-w-[140px] svelte-1i3s90c">`);
		$$renderer.select({
			name: "industry",
		...
		$$renderer.push(`</div> <div class="min-w-[140px] svelte-1i3s90c">`);
		$$renderer.select({
			name: "domain",
		...
		$$renderer.push(`</div> <div class="relative min-w-[140px] svelte-1i3s90c"><input type="text" name="location"${attr("value", searchLocation)} placeholder="Location..." class="w-full pl-9 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-blue-500 svelte-1i3s90c"/> <svg class="absolute left-3 top-3.5 h-3.5 w-3.5 text-slate-600 dark:text-slate-400 svelte-1i3s90c" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" stroke-width="2" class="svelte-1i3s90c"></path><circle cx="12" cy="10" r="3" stroke-width="2" class="svelte-1i3s90c"></circle></svg></div> <div class="min-w-[110px] svelte-1i3s90c">`);
		$$renderer.select({
			name: "mode",
			value: selectedMode,
			class: "w-full px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-900 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-blue-500"
		...
		$$renderer.push(`</div> <div class="min-w-[130px] svelte-1i3s90c">`);
		$$renderer.select({
			name: "type",
			value: selectedType,
			class: "w-full px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-900 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-blue-500"
		...
		$$renderer.push(`</div> <div class="flex gap-2 svelte-1i3s90c"><button type="submit" class="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-slate-900 dark:text-white font-bold text-xs transition-colors duration-200 cursor-pointer svelte-1i3s90c">Apply Filters</button> <a href="/student/companies" class="px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800/50 hover:bg-slate-900 text-slate-600 dark:text-slate-400 font-bold text-xs transition duration-200 cursor-pointer flex items-center justify-center svelte-1i3s90c">Reset</a></div></form></div> `);
