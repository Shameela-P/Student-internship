...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]--></div></div> <main class="grow flex flex-col relative z-10">`);
		children($$renderer);
