...
import { S as attr, a as head } from "../../chunks/server.js";
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div class="min-h-screen text-slate-800 bg-slate-50 dark:bg-surface dark:text-slate-100 transition-colors duration-300 relative overflow-x-hidden flex flex-col"><div class="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-indigo-500/10 blur-[150px] pointer-events-none"></div> <div class="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] rounded-full bg-emerald-500/10 blur-[180px] pointer-events-none"></div> <div class="fixed bottom-6 left-6 z-50">`);
		$$renderer.push("<!--[-1-->");
