...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]--></div></a></nav> <div class="p-4 border-t border-slate-200 bg-slate-50"><div class="flex items-center gap-3"><div class="h-10 w-10 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold uppercase border border-indigo-50/5">`);
