...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		function getLinkClass(path) {
			...
			return "flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-350 cursor-pointer text-slate-650 hover:bg-slate-50 hover:text-slate-900";
		}
