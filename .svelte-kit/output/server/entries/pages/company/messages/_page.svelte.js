...
import { i as ensure_array_like, r as derived, t as attr_class, w as escape_html } from "../../../../chunks/server.js";
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--></div></div> <div class="p-4 border-t border-divider dark:border-divider-dark/50 bg-slate-900/20 text-slate-500 text-[10px] font-bold">Connected as: ${escape_html(company().companyEmail)}</div></div> <div class="flex-grow flex flex-col justify-between bg-slate-950/20">`);
		$$renderer.push("<!--[-1-->");
