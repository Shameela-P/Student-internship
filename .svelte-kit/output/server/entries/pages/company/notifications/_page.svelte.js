...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div class="mb-8"><h1 class="font-display font-black text-3xl text-primary dark:text-primary-dark tracking-tight">Interactive Alert Inbox</h1> <p class="text-sm text-muted dark:text-muted-dark mt-1">Nexora email simulation inbox. View incoming notifications, registration confirmations, and applicant filing alerts.</p></div> `);
