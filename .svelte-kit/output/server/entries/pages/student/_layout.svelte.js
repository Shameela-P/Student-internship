import { C as clsx, S as attr, r as derived, t as attr_class, w as escape_html } from "../../../chunks/server.js";
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (unread() > 0) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<span class="absolute right-0 h-5 w-5 bg-rose-500 text-primary dark:text-primary-dark rounded-full flex items-center justify-center text-[10px] font-bold animate-pulse">${escape_html(unread())}</span>`);
		} else $$renderer.push("<!--[-1-->");
