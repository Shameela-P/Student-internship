...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`</select></div> <div class="col-span-2 lg:col-span-1 flex gap-2"><button type="submit" class="flex-grow py-2.5 px-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-slate-900 dark:text-white font-bold text-xs transition duration-200 cursor-pointer">Filter</button> <a href="/student/internships" class="px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800/50 hover:bg-slate-900 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white flex items-center justify-center cursor-pointer transition">Reset</a></div></div></form></div> `);
