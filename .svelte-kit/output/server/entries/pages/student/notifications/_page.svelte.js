...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4"><div><h1 class="font-display font-black text-3xl text-slate-900 tracking-tight">Interactive Alert Inbox</h1> <p class="text-sm text-slate-500 mt-1">Nexora email simulation inbox. Check automated emails, alerts, and registration notifications.</p></div> `);
