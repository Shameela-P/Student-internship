...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`</div> <div class="relative min-w-[140px] svelte-1i3s90c"><input type="text" name="location"${attr("value", searchLocation)} placeholder="Location..." class="w-full pl-9 pr-4 py-2.5 rounded-xl border border-divider dark:border-divider-dark bg-surface dark:bg-surface-dark/50 text-xs text-primary dark:text-primary-dark focus:outline-none focus:border-blue-500 svelte-1i3s90c"/> <svg class="absolute left-3 top-3.5 h-3.5 w-3.5 text-slate-600 dark:text-slate-400 svelte-1i3s90c" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" stroke-width="2" class="svelte-1i3s90c"></path><circle cx="12" cy="10" r="3" stroke-width="2" class="svelte-1i3s90c"></circle></svg></div> <div class="min-w-[110px] svelte-1i3s90c">`);
		$$renderer.select({
			name: "mode",
			value: selectedMode,
			class: "w-full px-3 py-2.5 rounded-xl border border-divider dark:border-divider-dark bg-slate-900 text-xs text-primary dark:text-primary-dark focus:outline-none focus:border-blue-500"
