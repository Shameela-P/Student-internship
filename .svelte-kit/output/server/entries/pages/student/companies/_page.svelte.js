...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let searchVal = initialFilters.query;
		let selectedIndustry = initialFilters.industry;
		let selectedDomain = initialFilters.domain;
		let searchLocation = initialFilters.location;
		let selectedMode = initialFilters.mode;
		let selectedType = initialFilters.type;
