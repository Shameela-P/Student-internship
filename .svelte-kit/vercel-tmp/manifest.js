	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/attachments/_filename_/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/messages/read/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/notifications/read/_server.js'))
			},
			{
				id: "/api/refresh",
				pattern: /^\/api\/refresh\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/refresh/_server.js'))
			},
			{
				...
				params: [{"name":"filename","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/resumes/_filename_/_server.js'))
			},
			{
				id: "/company",
				pattern: /^\/company\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/login/google/_server.js'))
			},
			{
				id: "/logout",
				pattern: /^\/logout\/?$/,
